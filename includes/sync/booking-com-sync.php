...
*/
    ...
    if (!class_exists('BookingComSync')){

        class BookingComSync extends Controller{

            function __construct(){
                parent::__construct();
            }

            public function booking_com_sync($room_type_id, $booking_com_url){
                $controller     =   new Controller;
                include $controller->plugin_path . 'includes/models/methods-api.php';
                $method         =   new Methods;
                $ical           =   new HASiCal($booking_com_url);
                    ...
                    foreach ($events as $event){
                        ...
                        global $wpdb;
                            ...
                            if ($exclude_flag == true){
                                ...
                                $method->has_create_booking_booking_com('booking.com',
                                                                        $check_in,
                                                                        $check_out,
                                                                        $room_type_id,
                                                                        $location,
