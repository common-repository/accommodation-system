...
*/
    ...
    if (!class_exists('AirBnBSync')){

        class AirBnBSync extends Controller{

            function __construct(){
                parent::__construct();
            }

            public function airbnb_sync($room_type_id,
                                        $airbnb_url){
                $controller     =   new Controller;
                include $controller->plugin_path . 'includes/models/methods-api.php';
                $method         =   new Methods;
                $ical           =   new HASiCal($airbnb_url);
                    ...
                    foreach ($events as $event){
                        ...
                        global $wpdb;
                            ...
                            if ($exclude_flag == true){
                                ...
                                $method->has_create_booking_airnbnb('airbnb',
                                                                    $check_in,
                                                                    $check_out,
                                                                    $room_type_id,
                                                                    'none',
