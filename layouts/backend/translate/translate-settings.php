...
*/
    ...
    if (!class_exists('TranslateSettings')){
        class TranslateSettings extends Translate{

            function __construct(){
                parent::__construct();
            }

            public static function translate_settings_layout(){
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div id="room-list">
                                    ...
                                    <?php
                                    $i = 0;
                                    $txt_list = $txt->txt_list('SETTINGS');
