...
*/
    ...
    if (!class_exists('TranslateTranslations')){
        class TranslateTranslations extends Translate{

            function __construct(){
                parent::__construct();
            }

            public static function translate_translations_layout(){
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div id="room-list">
                                    ...
                                    <?php
                                    $i = 0;
                                    $txt_list = $txt->txt_list('TRANSLATE');
