...
*/
    ...
    if (!class_exists('TranslateFrontend')){
        class TranslateFrontend extends Translate{

            function __construct(){
                parent::__construct();
            }

            public static function translate_frontend_layout(){
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="main-body-section">
                                <h3 class="panel-title"><?php echo $txt->txt('Manage translations') ?></h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div id="room-list">
                                    ...
                                    <?php
                                    $i = 0;
                                    $txt_list = $txt->txt_list('FRONTEND');
                                        ...
                                        <form method="post" action="<?php echo admin_url(); ?>admin-post.php"
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="field" class="form-control"
                                                       ...
                                                       accept="" value="<?php print_r($values['description']) ?>"
