...
?>
<script>
    function has_ajax_call(task_name,
                           is_modal,
                           is_delete,
                           response_holder,
                           param1,
    ...
    function bind_delete_form_with_ajax(task_name,
                                        response_holder){
        var options = {
...
<!-- Regular Modal -->
<div id="modal" class="modal left fade in" role="dialog">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php _e("Hotel booking system",
                                                 self::$text_domain) ?></h4>
            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="border-bottom:0px;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php _e("Confirm deletion?",
                                                 self::$text_domain) ?></h4>
            </div>
            <div class="modal-footer">
                <form method="post" action="<?php echo admin_url(); ?>admin-post.php" class="delete">
                    ...
                    <button type="submit"
                            class="btn btn-danger btn-sm"><?php _e("Delete",
                                                                   self::$text_domain) ?></button>
                    <button type="button" class="btn btn-default btn-sm"
                            data-dismiss="modal"><?php _e("Close",
                                                          self::$text_domain) ?></button>
                </form>
            </div>
        </div>
