...
*/
    ...
    if (!class_exists('RoomTypeDelete')){
        class RoomTypeDelete extends Reception{

            function __construct(){
                parent::__construct();
            }

            public static function room_type_delete_modal(){
                ...
                $room_type_id = sanitize_text_field($_POST['param1']);
                    ...
                    <form method="post" action="<?php echo admin_url(); ?>admin-post.php" class="room-type-delete">
                        <input type="hidden" name="action" value="has">
                        <input type="hidden" name="task" value="room_type_delete">
                    ...
                    <script type="text/javascript">
                        ...
                        .ready(function(){
                            ...
                            var options = {
                                ...
                                success     : response_room_type_delete,
                                resetForm   : true
                            };

                            // Binding the form for ajax submission
                            jQuery('.room-type-delete')
                            .submit(function(){
                                jQuery(this)
                                .ajaxSubmit(options);
                        ...
                        function response_room_type_delete(){
                            jQuery('#modal')
                            .modal('hide');
                            notify('<?php echo $txt->txt("Room type deleted successfully") ?>');
                            jQuery("#row_<?php echo $room_type_id;?>")
                            .remove();
