...
(function($){
    ...
    */
    ...
    $.fn.ajaxSubmit = function(options){
        ...
        if (options.beforeSubmit && options.beforeSubmit(a,
                                                         this,
                                                         options) === false){
        ...
        options.success = function(data,
                                   status,
                                   xhr){ // jQuery 1.4+ passes xhr as 3rd arg
        ...
        var fileInputs = $('input[type=file]:enabled',
                           this)
        .filter(function(){
            return $(this)
            .val() !== '';
        ...
        function fileUploadIframe(a){
            ...
            xhr = { // mock object
                ...
                abort                : function(status){
                    ...
                    $io.attr('src',
                             s.iframeSrc); // abort op in progress
                    xhr.error = e;
                    if (s.error){
            ...
            if (s.beforeSend && s.beforeSend.call(s.context,
                                                  xhr,
                                                  s) === false){
                if (s.global){
                    $.active--;
            ...
            function doSubmit(){
                ...
                try{
                    ...
                    if (io.attachEvent){
                        io.attachEvent('onload',
                                       cb);
                    }
                    else{
                        io.addEventListener('load',
                                            cb,
                                            false);
                    }
                    setTimeout(checkState,
            ...
            function cb(e){
                ...
                if (io.detachEvent){
                    io.detachEvent('onload',
                                   cb);
                }
                else{
                    io.removeEventListener('load',
                                           cb,
                                           false);
                }
            ...
            var toXml = $.parseXML || function(s,
                                               doc){ // use parseXML if available (jQuery 1.5+)
            ...
            var httpData = function(xhr,
                                    type,
                                    s){ // mostly lifted from jq1.4.4
    ...
    $.fn.ajaxForm = function(options){
        ...
        if (options.delegation){
            $(document)
            .off('submit.form-plugin',
                 this.selector,
                 doAjaxSubmit)
            .off('click.form-plugin',
                 this.selector,
                 captureSubmittingElement)
            .on('submit.form-plugin',
                this.selector,
                options,
                doAjaxSubmit)
            .on('click.form-plugin',
                this.selector,
                options,
                captureSubmittingElement);
            return this;
