...
(function($,
    ...
    var toasting =
                {
                    gettoaster: function(){
                        ...
                        if (toaster.length<1){
                            ...
                            if ((settings.stylesheet) && (!$("link[href="+settings.stylesheet+"]").length)){
                                $('head')
                                .appendTo('<link rel="stylesheet" href="'+settings.stylesheet+'">');
                            }

                            $(settings.toaster.container)
                            .append(toaster);
                        }
                    ...
                    notify: function(title,
                        ...
                        var delimiter = (title && message)
                                ? settings.toast.defaults.delimiter
                                : '';
    ...
    $.toaster = function(options){
        ...
        var message = ('message' in options)
                ? options.message
                : null;
