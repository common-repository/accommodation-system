...
(function($){
    ...
    Calendar.prototype = {
        ...
        _initializeOptions         : function(opt){
            ...
            this.options = {
                startYear               : !isNaN(parseInt(opt.startYear))
                        ? parseInt(opt.startYear)
                        : new Date().getFullYear(),
                minDate                 : opt.minDate instanceof Date
                        ? opt.minDate
                        : null,
                maxDate                 : opt.maxDate instanceof Date
                        ? opt.maxDate
                        : null,
                language                : (opt.language != null && dates[opt.language] != null)
                        ? opt.language
                        : 'en',
                allowOverlap            : opt.allowOverlap != null
                        ? opt.allowOverlap
                        : true,
                displayWeekNumber       : opt.displayWeekNumber != null
                        ? opt.displayWeekNumber
                        : false,
                alwaysHalfDay           : opt.alwaysHalfDay != null
                        ? opt.alwaysHalfDay
                        : false,
                enableRangeSelection    : opt.enableRangeSelection != null
                        ? opt.enableRangeSelection
                        : false,
                disabledDays            : opt.disabledDays instanceof Array
                        ? opt.disabledDays
                        : [],
                roundRangeLimits        : opt.roundRangeLimits != null
                        ? opt.roundRangeLimits
                        : false,
                dataSource              : opt.dataSource instanceof Array != null
                        ? opt.dataSource
                        : [],
                style                   : opt.style == 'background' || opt.style == 'border' || opt.style == 'custom'
                        ? opt.style
                        : 'border',
                enableContextMenu       : opt.enableContextMenu != null
                        ? opt.enableContextMenu
                        : false,
                contextMenuItems        : opt.contextMenuItems instanceof Array
                        ? opt.contextMenuItems
                        : [],
                customDayRenderer       : $.isFunction(opt.customDayRenderer)
                        ? opt.customDayRenderer
                        : null,
                customDataSourceRenderer: $.isFunction(opt.customDataSourceRenderer)
                        ? opt.customDataSourceRenderer
                        : null
            };
        ...
        _initializeEvents          : function(opt){
            ...
            if (opt.renderEnd){
                this.element.bind('renderEnd',
                                  opt.renderEnd);
            }
            if (opt.clickDay){
                this.element.bind('clickDay',
                                  opt.clickDay);
            }
            ...
            if (opt.selectRange){
                this.element.bind('selectRange',
                                  opt.selectRange);
            }
            if (opt.mouseOnDay){
                this.element.bind('mouseOnDay',
                                  opt.mouseOnDay);
            }
            if (opt.mouseOutDay){
                this.element.bind('mouseOutDay',
                                  opt.mouseOutDay);
            }
        },
        ...
        _render                    : function(){
            ...
            this._applyEvents();
            this.element.find('.months-container')
                .fadeIn(500);
        ...
        _renderHeader              : function(){
            ...
            if (this.options.minDate != null && this.options.minDate>new Date(this.options.startYear-1,
                                                                              11,
                                                                              31)){
            ...
            if (this.options.minDate != null && this.options.minDate>new Date(this.options.startYear-2,
                                                                              11,
                                                                              31)){
            ...
            if (this.options.maxDate != null && this.options.maxDate<new Date(this.options.startYear+1,
                                                                              0,
                                                                              1)){
            ...
            if (this.options.maxDate != null && this.options.maxDate<new Date(this.options.startYear+2,
                                                                              0,
                                                                              1)){
        ...
        _renderBody                : function(){
            ...
            for (var m = 0; m<12; m++){
                ...
                monthDiv.data('month-id',
                              m);

                var firstDate = new Date(this.options.startYear,
                                         m,
                                         1);
                ...
                var lastDate = new Date(this.options.startYear,
                                        m+1,
                                        0);
                    ...
                    do{
                        ...
                        if (currentDate<firstDate){
                            ...
                            if (this.options.customDayRenderer){
                                this.options.customDayRenderer(cellContent,
                                                               currentDate);
                            }
                        }
        ...
        _renderDataSource          : function(){
            ...
            if (this.options.dataSource != null && this.options.dataSource.length>0){
                this.element.find('.month-container')
                    .each(function(){
                        var month = $(this)
                        .data('month-id');

                        var firstDate = new Date(_this.options.startYear,
                                                 month,
                                                 1);
                        var lastDate = new Date(_this.options.startYear,
                                                month+1,
                                                0);
                        ...
                        if ((_this.options.minDate == null || lastDate>=_this.options.minDate) && (_this.options.maxDate == null || firstDate<=_this.options.maxDate)){
                            ...
                            if (monthData.length>0){
                                ...
                                .find('.day-content')
                                .each(function(){
                                    var currentDate = new Date(_this.options.startYear,
                                                               month,
                                                               $(this)
                                                               .text());
                                    ...
                                    if ((_this.options.minDate == null || currentDate>=_this.options.minDate) && (_this.options.maxDate == null || currentDate<=_this.options.maxDate)){
                                        ...
                                        if (dayData.length>0){
                                            _this._renderDataSourceDay($(this),
                                                                       currentDate,
                                                                       dayData);
                                        }
                                    }
        ...
        _renderDataSourceDay       : function(elt,
                                              currentDate,
                                              events){
            switch (this.options.style){
                ...
                case 'background':
                    ...
                    if (events[events.length-1].startDate.getTime() == currentTime){
                        ...
                        if (events[events.length-1].startHalfDay || this.options.alwaysHalfDay){
                            ...
                            elt.parent()
                               .css('background',
                                    'linear-gradient(-45deg, '+events[events.length-1].color+', '+events[events.length-1].color+' 49%, '+otherColor+' 51%, '+otherColor+')');
                        }
                        ...
                        if (events[events.length-1].endHalfDay || this.options.alwaysHalfDay){
                            ...
                            elt.parent()
                               .css('background',
                                    'linear-gradient(135deg, '+events[events.length-1].color+', '+events[events.length-1].color+' 49%, '+otherColor+' 51%, '+otherColor+')');
                        }
                        else if (this.options.roundRangeLimits){
                            elt.parent()
                ...
                case 'custom':
                    if (this.options.customDataSourceRenderer){
                        this.options.customDataSourceRenderer.call(this,
                                                                   elt,
                                                                   currentDate,
                                                                   events);
                    }
        ...
        _applyEvents               : function(){
            ...
            /* Header buttons */
            this.element.find('.year-neighbor, .year-neighbor2')
                .click(function(){
                    if (!$(this)
                    .hasClass('disabled')){
                        _this.setYear(parseInt($(this)
                                               .text()));
                    }
                });

            this.element.find('.calendar-header .prev')
                .click(function(){
                    if (!$(this)
                    .hasClass('disabled')){
                        _this.element.find('.months-container')
            ...
            this.element.find('.calendar-header .next')
                .click(function(){
                    if (!$(this)
                    .hasClass('disabled')){
                        _this.element.find('.months-container')
            ...
            if (this.options.enableRangeSelection){
                    ...
                    if (_this._mouseDown){
                        ...
                        if (!_this.options.allowOverlap){
                            ...
                            if (newDate<currentDate){
                                var nextDate = new Date(newDate.getFullYear(),
                                                        newDate.getMonth(),
                                                        newDate.getDate()+1);
                ...
                .mouseup(function(e){
                    if (_this._mouseDown){
                        ...
                        var minDate = _this._rangeStart<_this._rangeEnd
                                ? _this._rangeStart
                                : _this._rangeEnd;
                        var maxDate = _this._rangeEnd>_this._rangeStart
                                ? _this._rangeEnd
                                : _this._rangeStart;
            ...
            setInterval(function(){
                            var calendarSize = $(_this.element)
                            .width();
                            var monthSize = $(_this.element)
                            .find('.month')
                            .first()
                            .width()+10;
        ...
        _refreshRange              : function(){
            ...
            this.element.find('td.day.range')
                .removeClass('range');
            this.element.find('td.day.range-start')
                .removeClass('range-start');
            this.element.find('td.day.range-end')
        ...
        _openContextMenu           : function(elt){
            ...
            for (var i in events){
                ...
                eventItem.css('border-left',
                              '4px solid '+events[i].color);
                ...
                this._renderContextMenuItems(eventItem,
            ...
            if (contextMenu.children().length>0){
                contextMenu.css('left',
                                elt.offset().left+25+'px');
                contextMenu.css('top',
                                elt.offset().top+25+'px');
                contextMenu.show();
        ...
        _renderContextMenuItems    : function(parent,
                                              items,
                                              evt){
            ...
            for (var i in items){
                if (!items[i].visible || items[i].visible(evt)){
                    ...
                    if (items[i].items && items[i].items.length>0){
                        this._renderContextMenuItems(menuItem,
                                                     items[i].items,
                                                     evt);
                    }
        ...
        _getDate                   : function(elt){
            var day = elt.children('.day-content')
                         .text();
            var month = elt.closest('.month-container')
                           .data('month-id');
        ...
        getWeekNumber              : function(date){
            ...
            var week1 = new Date(tempDate.getFullYear(),
                                 0,
                                 4);
        ...
        setStyle                   : function(style){
            this.options.style = style == 'background' || style == 'border' || style == 'custom'
                    ? style
                    : 'border';
            this._render();
        },
        ...
        setDisabledDays            : function(disabledDays){
            this.options.disabledDays = disabledDays instanceof Array
                    ? disabledDays
                    : [];
            this._render();
        },
        ...
        setContextMenuItems        : function(contextMenuItems){
            this.options.contextMenuItems = contextMenuItems instanceof Array
                    ? contextMenuItems
                    : [];
            this._render();
        },
        ...
        setCustomDayRenderer       : function(customDayRenderer){
            this.options.customDayRenderer = $.isFunction(customDayRenderer)
                    ? customDayRenderer
                    : null;
            this._render();
        },
        ...
        setCustomDataSourceRenderer: function(customDataSourceRenderer){
            this.options.customDataSourceRenderer = $.isFunction(customDataSourceRenderer)
        ...
        setDataSource              : function(dataSource){
            this.options.dataSource = dataSource instanceof Array
                    ? dataSource
                    : [];
            this._initializeDatasourceColors();
            this._render();
    ...
    var colors = $.fn.calendar.colors = ['#2c8fc9',
                                         '#9cb703',
                                         '#f5bb00',
                                         '#ff4a32',
                                         '#b56ce2',
                                         '#45a597'];
    //        var colors = $.fn.calendar.colors = ['#44c66c'];
